        ...
        <div class="row mt-2">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?= validation_errors() ?>
                        <form action="<?= base_url('cadangan/save_cadangan') ?>" method="POST">
                            <div class="form-group">
                                <label>ID Cadangan</label>
                                <div class="input-group">
                                    <input type="text" name="id_cadangan" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="nama_cadangan" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="tipe_cadangan" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
