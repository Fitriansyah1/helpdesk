...
class Karyawan extends CI_Controller
{
    ...
    {
        $data['karyawan'] = $this->M_karyawan->get_karyawan();
        $this->template->load('back/template', 'back/karyawan/print_karyawan', $data);
    }

    function add_karyawan()
    {
        $this->template->load('back/template', 'back/karyawan/form_karyawan');
    }
    ...
    function profile($id)
    {
        ...
        if ($data['karyawan']) {
            ...
            $this->template->load('back/template', 'back/karyawan/profile', $data);
        } else {
